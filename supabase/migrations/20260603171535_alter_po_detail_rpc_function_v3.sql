-- This hate fuiled migration is an attempt to fix the work function in my system
...
begin
  ...
  grouped_boxes as (
    ...
    from (
      ...
      group by purchase_order_id, product_product_id, product_name, product_item_num, product_upc, product_fnsku, product_asin, units_per_case
    ) pb
