-- I will be extending the purchase_order_detail rpc function (yet again) to stitch the allocations directly to the raw lines as well as placing them in an array. This seems infinitely easier than doing it in the front end
...
ALTER TABLE public.po_raw_lines
    DROP COLUMN IF EXISTS fba_prep;

ALTER TABLE public.po_raw_lines
    DROP COLUMN IF EXISTS fbm;