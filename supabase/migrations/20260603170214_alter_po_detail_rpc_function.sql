-- The purpose of this migration is to alter the purchase order detail function to make sure grouped boxes are separated by unit count and also contain the purchase order id
...
begin
  ...
  grouped_boxes as (
    ...
    from (
      ...
      group by purchase_order_id, product_product_id, product_name, product_item_num, product_upc, units_per_case
    ) pb
