...
ALTER TABLE "public"."picklist_elements" ALTER COLUMN "picklist_element_id" ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE "public"."picklists" ALTER COLUMN "picklist_id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
CREATE INDEX "picklist_elements_recipe_id_idx" ON "public"."picklist_elements" USING "btree" ("recipe_id");
...
ALTER TABLE ONLY "public"."picklist_elements"
    ADD CONSTRAINT "picklist_elements_picklist_id_fk" FOREIGN KEY ("picklist_id") REFERENCES "public"."picklists"("picklist_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."picklist_elements"
    ADD CONSTRAINT "picklist_elements_recipe_id_fk" FOREIGN KEY ("recipe_id") REFERENCES "public"."recipes"("recipe_id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."requests_to_process"
    ADD CONSTRAINT "requests_to_process_picklist_id_fkey" FOREIGN KEY ("picklist_id") REFERENCES "public"."picklists"("picklist_id") ON DELETE CASCADE;
