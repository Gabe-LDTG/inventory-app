-- This migration adds the three new po raw line fields (store, fbm, and fba_prep) to the po_details view. This will allow these new fields to be included in any queries against po_details
