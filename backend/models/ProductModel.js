...
const prodToInsert = '(name, asin, fnsku, upc, notes, 30_day_storage_cost, amz_fees_cost, amz_fulfilment_cost, bag_cost, bag_size, box_cost, box_type, date_added, do_we_carry, holiday_storage_cost, in_shipping_cost, item_cost, item_num, labor_cost, map, meltable, misc_cost, out_shipping_cost, price_2021, price_2022, price_2023, process_time_per_unit_sec, products_needed_a, qty_1, products_needed_b, qty_2, products_needed_c, qty_3, products_needed_d, qty_4, products_needed_e, qty_5, products_needed_f, qty_6, total_cost, total_holiday_cost, vendor, weight_lbs)';
